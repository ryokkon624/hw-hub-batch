...
public class MyBatisHouseworkTaskRepository implements HouseworkTaskRepository {
    ...
    public int updateTaskSnapshot(
            long houseworkId, LocalDate from, String name, String description, String category, long userId, String programName) {
        return customMapper.updateTaskSnapshot(houseworkId, from, name, description, category, userId, programName);
    }
     ...
     */
    @Override
    public int updateAssigneeForSystemAssigned(long houseworkId, LocalDate from, Long newAssigneeUserId, long userId, String programName) {
        return customMapper.updateAssigneeForSystemAssigned(houseworkId, from, newAssigneeUserId, userId, programName);
    }
}
